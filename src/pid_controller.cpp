...
void PidController::onInit() {
  ...
  debugPub = nh_.advertise<mrs_controllers::debug>("debug", 1);
  ...
  pluginlib::ClassLoader<mrs_uav_manager::Tracker> trackers_loader("mrs_uav_manager", "mrs_uav_manager::Tracker");
  ...
  f = boost::bind(&SetGainsDRS, _1, _2);
