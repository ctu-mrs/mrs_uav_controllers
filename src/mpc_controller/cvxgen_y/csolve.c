...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  if (nrhs > 1) {
    /* Assume that the second argument is the settingsControllerY. */
    if (mxGetField(prhs[1], 0, "eps") != NULL)
      settingsControllerY.eps = *mxGetPr(mxGetField(prhs[1], 0, "eps"));
    if (mxGetField(prhs[1], 0, "max_iters") != NULL)
      settingsControllerY.max_iters = *mxGetPr(mxGetField(prhs[1], 0, "max_iters"));
    if (mxGetField(prhs[1], 0, "refine_steps") != NULL)
      settingsControllerY.refine_steps = *mxGetPr(mxGetField(prhs[1], 0, "refine_steps"));
    if (mxGetField(prhs[1], 0, "verbose") != NULL)
      settingsControllerY.verbose = *mxGetPr(mxGetField(prhs[1], 0, "verbose"));
    if (mxGetField(prhs[1], 0, "better_start") != NULL)
      settingsControllerY.better_start = *mxGetPr(mxGetField(prhs[1], 0, "better_start"));
    if (mxGetField(prhs[1], 0, "verbose_refinement") != NULL)
      settingsControllerY.verbose_refinement = *mxGetPr(mxGetField(prhs[1], 0,
            "verbose_refinement"));
    if (mxGetField(prhs[1], 0, "debug") != NULL)
      settingsControllerY.debug = *mxGetPr(mxGetField(prhs[1], 0, "debug"));
    if (mxGetField(prhs[1], 0, "kkt_reg") != NULL)
      settingsControllerY.kkt_reg = *mxGetPr(mxGetField(prhs[1], 0, "kkt_reg"));
    if (mxGetField(prhs[1], 0, "s_init") != NULL)
      settingsControllerY.s_init = *mxGetPr(mxGetField(prhs[1], 0, "s_init"));
    if (mxGetField(prhs[1], 0, "z_init") != NULL)
      settingsControllerY.z_init = *mxGetPr(mxGetField(prhs[1], 0, "z_init"));
    if (mxGetField(prhs[1], 0, "resid_tol") != NULL)
      settingsControllerY.resid_tol = *mxGetPr(mxGetField(prhs[1], 0, "resid_tol"));
  ...
  valid_varsControllerY = 0;
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "A");
  if (xm == NULL) {
    printf("could not find paramsControllerY.A.\n");
  } else {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.B.\n");
  } else {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.Bf.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.Q.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 3))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.Q_last.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 3))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.du_max.\n");
  } else {
  ...
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "du_max_f");
  if (xm == NULL) {
    printf("could not find paramsControllerY.du_max_f.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
      printf("du_max_f must be size (1,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter du_max_f must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter du_max_f must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter du_max_f must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = paramsControllerY.du_max_f;
      src = mxGetPr(xm);
      for (i = 0; i < 1; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.u_last.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.u_max.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_0.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_max_1.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_max_1;
      src = mxGetPr(xm);
      for (i = 0; i < 1; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_1 or paramsControllerY.x_ss{1}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_2 or paramsControllerY.x_ss{2}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_3 or paramsControllerY.x_ss{3}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_4 or paramsControllerY.x_ss{4}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_5 or paramsControllerY.x_ss{5}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_6 or paramsControllerY.x_ss{6}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_7 or paramsControllerY.x_ss{7}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_8 or paramsControllerY.x_ss{8}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_9 or paramsControllerY.x_ss{9}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_10 or paramsControllerY.x_ss{10}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_10;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_11 or paramsControllerY.x_ss{11}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_11;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_12 or paramsControllerY.x_ss{12}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_12;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_13 or paramsControllerY.x_ss{13}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_13;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_14 or paramsControllerY.x_ss{14}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_14;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_15 or paramsControllerY.x_ss{15}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_15;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_16 or paramsControllerY.x_ss{16}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_16;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_17 or paramsControllerY.x_ss{17}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_17;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_18 or paramsControllerY.x_ss{18}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_18;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_19 or paramsControllerY.x_ss{19}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_19;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_20 or paramsControllerY.x_ss{20}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_20;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_21 or paramsControllerY.x_ss{21}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_21;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_22 or paramsControllerY.x_ss{22}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_22;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_23 or paramsControllerY.x_ss{23}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_23;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_24 or paramsControllerY.x_ss{24}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_24;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_25 or paramsControllerY.x_ss{25}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_25;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (xm == NULL) {
    printf("could not find paramsControllerY.x_ss_26 or paramsControllerY.x_ss{26}.\n");
  } else {
    if (!((mxGetM(xm) == 3) && (mxGetN(xm) == 1))) {
    ...
    if (this_var_errors == 0) {
      dest = paramsControllerY.x_ss_26;
      src = mxGetPr(xm);
      for (i = 0; i < 3; i++)
        *dest++ = *src++;
      valid_varsControllerY++;
  ...
  if (valid_varsControllerY != 38) {
    printf("Error: %d parameters are invalid.\n", 38 - valid_varsControllerY);
    mexErrMsgTxt("invalid parameters found.");
  }
  if (prepare_for_c) {
    printf("settingsControllerY.prepare_for_c == 1. thus, outputting for C.\n");
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_1[%d] = %.6g;\n", i, paramsControllerY.x_ss_1[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.Q[%d] = %.6g;\n", i, paramsControllerY.Q[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_2[%d] = %.6g;\n", i, paramsControllerY.x_ss_2[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_3[%d] = %.6g;\n", i, paramsControllerY.x_ss_3[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_4[%d] = %.6g;\n", i, paramsControllerY.x_ss_4[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_5[%d] = %.6g;\n", i, paramsControllerY.x_ss_5[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_6[%d] = %.6g;\n", i, paramsControllerY.x_ss_6[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_7[%d] = %.6g;\n", i, paramsControllerY.x_ss_7[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_8[%d] = %.6g;\n", i, paramsControllerY.x_ss_8[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_9[%d] = %.6g;\n", i, paramsControllerY.x_ss_9[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_10[%d] = %.6g;\n", i, paramsControllerY.x_ss_10[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_11[%d] = %.6g;\n", i, paramsControllerY.x_ss_11[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_12[%d] = %.6g;\n", i, paramsControllerY.x_ss_12[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_13[%d] = %.6g;\n", i, paramsControllerY.x_ss_13[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_14[%d] = %.6g;\n", i, paramsControllerY.x_ss_14[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_15[%d] = %.6g;\n", i, paramsControllerY.x_ss_15[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_16[%d] = %.6g;\n", i, paramsControllerY.x_ss_16[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_17[%d] = %.6g;\n", i, paramsControllerY.x_ss_17[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_18[%d] = %.6g;\n", i, paramsControllerY.x_ss_18[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_19[%d] = %.6g;\n", i, paramsControllerY.x_ss_19[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_20[%d] = %.6g;\n", i, paramsControllerY.x_ss_20[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_21[%d] = %.6g;\n", i, paramsControllerY.x_ss_21[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_22[%d] = %.6g;\n", i, paramsControllerY.x_ss_22[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_23[%d] = %.6g;\n", i, paramsControllerY.x_ss_23[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_24[%d] = %.6g;\n", i, paramsControllerY.x_ss_24[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_25[%d] = %.6g;\n", i, paramsControllerY.x_ss_25[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_ss_26[%d] = %.6g;\n", i, paramsControllerY.x_ss_26[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.Q_last[%d] = %.6g;\n", i, paramsControllerY.Q_last[i]);
    for (i = 0; i < 4; i++)
      printf("  paramsControllerY.Af[%d] = %.6g;\n", i, paramsControllerY.Af[i]);
    for (i = 0; i < 3; i++)
      printf("  paramsControllerY.x_0[%d] = %.6g;\n", i, paramsControllerY.x_0[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsControllerY.Bf[%d] = %.6g;\n", i, paramsControllerY.Bf[i]);
    for (i = 0; i < 4; i++)
      printf("  paramsControllerY.A[%d] = %.6g;\n", i, paramsControllerY.A[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsControllerY.B[%d] = %.6g;\n", i, paramsControllerY.B[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsControllerY.u_max[%d] = %.6g;\n", i, paramsControllerY.u_max[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsControllerY.u_last[%d] = %.6g;\n", i, paramsControllerY.u_last[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsControllerY.du_max_f[%d] = %.6g;\n", i, paramsControllerY.du_max_f[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsControllerY.du_max[%d] = %.6g;\n", i, paramsControllerY.du_max[i]);
    for (i = 0; i < 1; i++)
      printf("  paramsControllerY.x_max_1[%d] = %.6g;\n", i, paramsControllerY.x_max_1[i]);
  }
  /* Perform the actual solve in here. */
  steps = solve_controllerY();
  /* For profiling purposes, allow extra silent solves if desired. */
  settingsControllerY.verbose = 0;
  ...
  *mxGetPr(xm) = workControllerY.optval;
  xm = mxCreateDoubleMatrix(1, 1, mxREAL);
  mxSetField(plhs[1], 0, "gap", xm);
  *mxGetPr(xm) = workControllerY.gap;
  xm = mxCreateDoubleMatrix(1, 1, mxREAL);
  mxSetField(plhs[1], 0, "steps", xm);
  *mxGetPr(xm) = steps;
  xm = mxCreateDoubleMatrix(1, 1, mxREAL);
  mxSetField(plhs[1], 0, "converged", xm);
  *mxGetPr(xm) = workControllerY.converged;
